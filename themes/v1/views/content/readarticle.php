			...
			<?php else: ?>
				...
				<div id="content-detail-readarticle" class="page content-detail" >
					...
					<div class="inner">
						...
						?>
							<?php if($in == 1): ?>
							<div class="img-content-detail"><img src="http://poin.mdmedia.co.id<?php echo Yii::app()->request->baseUrl; ?>/assets/content/<?php echo $i->filename; ?>" alt="<?php echo $i->title; ?>" width="400" /></div>
							<?php endif; ?>
						<?php endforeach; ?>
					...
					<div class="print-row">
						<div class="inner">
							<a href="<?php echo Yii::app()->request->baseUrl; ?>/print/<?php echo $article->slug; ?>" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/09-email-print-pdf-icon.png" alt="09-email-print-pdf-icon" /></a>
						</div>
					</div>
