	...
	<div id="torso" class="torso">
		<div id="content" class="container_241">
			<div id="main" class="grid_161">
               ...
               <?php // 
				/*
               	<video width="454" height="340" autoplay loop>
				  	<object data="/ariwa/np_movie/banner_login_poin.swf" width="454" height="340">
				    		<embed src="/ariwa/np_movie/banner_login_poin.swf" width="454" height="340">
				  	</object>
				</video>
				
				2.
				<img src="/ariwa/np_images/loginlogo.png" height="340px" />
				3.
				<img src="/ariwa/np_images/poin_login_lebaran.jpg" height="340px" />
				4.
				<object data="/ariwa/np_movie/banner_login_poin.swf" width="454" height="340"></object>
				*/
               ?>
