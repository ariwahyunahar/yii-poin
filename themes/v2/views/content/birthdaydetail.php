			...
			<div class="inner">
				...
				<div id="content-detail-all-<?php echo $idpage ?>" class="page" >
					...
					<div class="inner">
                        ...
                        <div class="items">
							<div class="img-item item"><img src="http://172.9.1.78/hris/pic/<?php echo $member->nik; ?>.jpg" alt="<?php echo $member->name; ?>" width="172px" height="231px"  /></div>
                            ...
                            <?php 
								...
								$date = $arr[sizeof($arr)-1];
								$patterns = '/0/';
								$replacements = ''; 
								$month = preg_replace($patterns, $replacements, $arr[sizeof($arr)-2]);
								echo Yii::app()->util->getBirthday($month.'-'.$date);
							?>
                            </div>
		...
		<div id="postscript-right" class="grid_8">
			...
			<div id="tabs" class="block radius shadow">
					...
					<div id="TabKurs">
						...
						<iframe id="editPwd" src="http://client.mediadesain.com/kurs-bca/"></iframe>
