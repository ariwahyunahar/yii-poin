<?php
	class PollingempWidget extends CWidget
	{
...
//			);
			...
			// apakah sudah melakukan poling employee OR
			$usr = Yii::app()->user->name;
			$criteria = new CDbCriteria;
			$criteria->condition = "polling_id = 6 and member_id = '".$usr."'";
			$usr_vote_employee_or = MemberVote::model()->count($criteria);
			
			// apakah sudah melakukan poling employee OS
			$usr = Yii::app()->user->name;
			$criteria = new CDbCriteria;
			$criteria->condition = "polling_id = 8 and member_id = '".$usr."'";
			$usr_vote_employee_os = MemberVote::model()->count($criteria);
			...
			$vars= array(
				...
				'usr_vote_employee_or' => $usr_vote_employee_or,
				'usr_vote_employee_os' => $usr_vote_employee_os,
