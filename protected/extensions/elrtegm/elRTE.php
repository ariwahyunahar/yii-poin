...
class elRTE extends CInputWidget
{
    ...
    public function generateOptions()
    {
        ...
        $options .= "         'url' : '{$this->baseUrl}/connectors/php/" . $this->connector . "', \n";
    ...
    {                
        ...
        $js .= "$('#".$this->selector."').elrte(opts);";*/
				$js .= "var elf = $('#".$this->selector."').elfinder({
                                        //url : '{$this->baseUrl}/connectors/php/" . $this->connector . "',
                                        url : '" . Yii::app()->request->baseUrl . "/documentgm/" . $this->connector . "',
