...
//		return $hijriDayString .' ' . $hijriDay . ' ' . $hijriMonthName . ' ' . $hijriYear;
	...
	public function actionGetsimulasipendi()
	{
		...
		$url=PAYMS_SERVER_GET. $n."___".$s."___".$PRD."___".Yii::app()->session['psw'] . "___1" ;
		$i = @file_get_contents($url);
		...
		$hsl = $hsl->rslt;
			...
			<div>SIMULASI PERHITUNGAN KOMPENSASI</div>
			<div>VOLUNTARY SEPARATION PROGRAM (VSP) 2015</div>
			</div>
			<div>
			<table cellpadding="2" cellspacing="0" width="100%" border="0">
			
				<tr>
					<td style="font-size: 18px;background-color: blue;color: #fff;" colspan="3">DATA PEKERJA</td>
				</tr>
				
				<tr>
					<td width="70%">NIK</td>
					<td width="2%">:</td>
					<td width="28%" align="left">'.$hsl->NIK.'</td>
				</tr>
				<tr>
					<td>Nama</td>
					<td>:</td>
					<td align="left">'.$hsl->NAMA_KARYAWAN.'</td>
				</tr>
				<tr>
					<td>Departemen</td>
					<td>:</td>
					<td align="left">'.$hsl->NAMA_DEPT.'</td>
				</tr>
				<tr>
					<td>Level</td>
					<td>:</td>
					<td align="left">'.$hsl->LEVEL_ID.'</td>
				</tr>
				<tr>
					<td>Tanggal Lahir</td>
					<td>:</td>
					<td align="left">'.substr($hsl->TGL_LAHIR, 0, 10) .'</td>
				</tr>
				<tr>
					<td>Tanggal Mulai Bekerja</td>
					<td>:</td>
					<td align="left">'.substr($hsl->TGL_MASUK, 0, 10).'</td>
				</tr>
				<tr>
					<td>Cut Off</td>
					<td>:</td>
				...
				<tr>
					<td>Usia</td>
					<td>:</td>
					<td align="left">'.$hsl->USIA.'</td>
				</tr>
				<tr>
					<td>Masa Kerja</td>
					<td>:</td>
					<td align="left">'.$hsl->MASA_KERJA.'</td>
				</tr>
				<tr>
					<td>Sisa Cuti</td>
					<td>:</td>
				...
				<tr>
					<td style="font-size: 18px;background-color: blue;color: #fff;">DESKRIPSI</td>
					<td style="font-size: 18px;background-color: blue;color: #fff;">&nbsp;</td>
					<td align="right" style="font-size: 18px;background-color: blue;color: #fff;">NILAI (Rp.)</td>
				</tr>
				
				<tr>
					<td>1.  Pesangon</td>
					<td>:</td>
					<td align="right">'.$this->formatmoney($hsl->PESANGON).'</td>
				</tr>
				<tr>
					<td>2.  Penghargaan Masa Kerja</td>
					<td>:</td>
					<td align="right">'.$this->formatmoney($hsl->PMK).'</td>
				</tr>
				<tr>
					<td>3.  Penggantian Hak</td>
					<td>:</td>
					<td align="right">'.$this->formatmoney($hsl->PENGGANTIAN_HAK).'</td>
				</tr>
				<tr>
					<td>4.  Uang Pisah</td>
					<td>:</td>
					<td align="right">'.$this->formatmoney($hsl->UANG_PISAH).'</td>
				</tr>
				<tr>
					<td>5.  Sisa Cuti</td>
					<td>:</td>
					<td align="right">'. $this->formatmoney($hsl->PENGGANTIAN_SISA_CUTI).'</td>
				</tr>
				<tr>
					<td>6.  Sweetener ( 3 x THP )</td>
					<td>:</td>
					<td align="right">'.$this->formatmoney($hsl->SWEETENER_TOTAL).'</td>
				</tr>
				
				<tr>
					<td style="background-color: blue;color: #fff;">TOTAL VSP</td>
					<td style="background-color: blue;color: #fff;">&nbsp;</td>
					<td align="right" style="background-color: blue;color: #fff;">'.$this->formatmoney($hsl->TOTAL).'</td>
				</tr>
			</table>
			</div>
			...
			$pdf->Output('simulasipendi.pdf', 'D');
