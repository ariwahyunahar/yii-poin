...
class DocController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$user = Member::model()->findAll($criteria);
	...
	public function actionIndexadmin()
	{
		...
		if (Yii::app()->user->isGuest) $this->redirect(Yii::app()->request->baseUrl . '/admin/login');
		$this->pageTitle = 'Document Browser';
		//$this->globalVars['activeMenu']['docbrowser'] = 'active';
	...
	public function actionConnectormtisna() {
		...
		$opts = array(
			'root'          => $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'assets/bpjs_/',  // path to root directory
			'URL'           => '/assets/bpjs_/', // root directory URL
			'rootAlias'     => 'BPJS',       // display this instead of root directory name
			'uploadAllow'   => array('all'),
			'uploadDeny'    => array(),
			'uploadOrder'   => 'allow,deny',
			// 'disabled'     => array(),      // list of not allowed commands
	...
	public function actionConnectormspt() {
		...
		$opts = array(
			'root'          => $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'assets/spt_/',  // path to root directory
			'URL'           => '/assets/spt_/', // root directory URL
			'rootAlias'     => 'SPT',       // display this instead of root directory name
			'uploadAllow'   => array('all'),
			'uploadDeny'    => array(),
			'uploadOrder'   => 'allow,deny',
			// 'disabled'     => array(),      // list of not allowed commands
