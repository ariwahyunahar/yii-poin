...
//            '!=': '$ must be different than %'
    		'default': 'Ada error.',
            'NOTEMPTY': 'Field ini tidak boleh kosong.',
            'NUMERIC': 'Isi dengan angka.',
            'STRING': 'Isi dengan teks.',
            'NOSPACE': 'Tidak boleh ada sepasi',
            'TRIM': 'Diawal dan di akhir tidak boleh ada sepasi',
            'MIXED': 'Isi dengan teks/angka, tidak boleh ada spesial karakter.',
            'DATE': 'harus dengan format YYYY-MM-DD',
            'EMAIL': 'Isi dengan alamt email yang benar, contoh alamat@email.com',
            'URL': 'Isi dengan URL yang benar.',
            'PHONE': 'Isi nomor telpon',
            //'INARRAY': '$ is not a valid option.',
            '<': 'Isi lebih kecil dari % karakter.',
            '<=': 'Isi lebih kecil dari atau sama dengan % karakter.',
            '>': 'Isi lebih besar dari % karakter.',
            '>=': 'Isi lebih besar dari atau sama dengan % karakter.',
            '==': 'Isi sama dengan %',
            '!=': 'Isi selain dari %'
        }),
