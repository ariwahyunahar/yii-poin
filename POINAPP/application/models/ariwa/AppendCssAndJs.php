...
class Model_ariwa_AppendCssAndJs
{
	public static function ariwa_include_all($base_url)
	{
		...
		$string .= '<script type="text/javascript" src="'.$base_url.'/extjs/ext-all.js"></script>';
	...
	public static function ariwa_include_css($base_url)
	{
		...
		// utuk kalender
		$string .= '<link rel="stylesheet" type="text/css" href="'.$base_url.'/extjs/kalender/resources/css/extensible-all.css" />';
	...
	public static function ariwa_include_js($base_url)
	{
		...
		//js kalender
		$string.= '	<script type="text/javascript" src="'.$base_url.'/extjs/kalender/extensible-all.js"></script>';
